    ...
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <div className="flex w-full md:justify-start justify-center items-end">
        <div className="relative mr-4 md:w-full lg:w-full xl:w-1/2 w-2/4">
          {/* <label for="hero-field" className="leading-7 text-sm text-white mt-[10px]">Placeholder</label> */}
          <input type="text" id="hero-field" name="hero-field" className="w-full blue-glassmorphism rounded mt-4 border bg-opacity-50 border-gray-300 focus:ring-2 focus:ring-indigo-200 focus:bg-transparent focus:border-indigo-500 text-base outline-none text-white py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
        </div>
        <button className="inline-flex text-white bg-[#8A42D8] font-normal border-0 py-2 px-6 focus:outline-none hover:bg-indigo-700 rounded text-lg" onClick={onCreatedNFT}>Host Now</button>
      </div>
      {/* <p className="text-sm mt-2 text-gray-200 mb-8 w-full">Neutra shabby chic ramps, viral fixie.</p> */}
      <div className="flex lg:flex-row md:flex-col mt-7">
